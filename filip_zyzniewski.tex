...
\item Bourne again shell programming
\item GNU/Linux systems engineering
\item Java virtual machine garbage collectors
\item Zabbix (user side)
\item git
\end{itemize}
Experience in the past (and/or shallow):
designing and prototyping electronic devices,
