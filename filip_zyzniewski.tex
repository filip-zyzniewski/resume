...
\item
Lecturer during the ``Commercial applications of Open Source software''
conference in May 2006, subject of the lecture:
``Open Source and public education''.
\item
Lecturer during the ``Free Software in home, work and school'' conference in
November 2004, subject of the lecture: ``Graphical terminals''.
– Conducted the ``Internals of the Unix systems'' classes at the Department of
Mathematics of University of Łódź (one term).
\end{itemize}
}
