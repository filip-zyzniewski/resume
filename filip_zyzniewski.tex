...
\begin{document}
  ...
  \section{Key competences}
    ...
    \begin{itemize}
    \item Responsible for services handling 0.6 million QPS, over 100TB of data.
    \item Responsible for services processing cardholder data.
    \item Oncall with a 5 minute response SLO.
    \item Cloud deployments (e.g. AWS, Kubernetes)
    \item Monitoring and alerting (e.g. Prometheus, Grafana, AWS Cloudwatch, Opsgenie)
    \item Continuous deployment (e.g. GitHub Actions with OIDC, Flux CD, Flagger).
    \item Change management.
    \item Performance engineering.
    \item Load balancing.
    \item Capacity planning.
    \item Data integrity: replication, redundancy, backups.
    \item Infrastructure as code (e.g. Pulumi, Kustomize, Flux CD, Terraform, SOPS).
    \end{itemize}
    \item Software development
    \begin{itemize}
    \item Languages: Python, Bourne shell, Go.
    ...
    (communication, negotiation, NVC), working in fully remote positions, public speaking.
    }
  ...
  \section{Experience}
    ...
    \cventry{2020--now}{Site Reliability Engineer}{\href{https://www.vertexinc.com/}{Vertex}}{Killorglin, Ireland (remotely)}{}{
      Member of the Taxamo SRE team \newline{}
      \textbf{Responsibilities}:
      \begin{itemize}
        \item Development and maintenance of the
        \href{https://www.vertexinc.com/solutions/products/taxamo-assure}{Taxamo} cloud infrastructure.
        \item Running the components of the solution (onduty, releases, deployments).
        \item Mentoring on good Site Reliability Engineering practices.
      \end{itemize}
      \textbf{Achievements}:
      \begin{itemize}
        \item Introduced a peer-reviewed configuration change management system encompassing almost all of our environments.
        \item Designed and implemented a Kubernetes platform for our workloads.
        \item Migrated all environments from bare EC2 instances to containers running on our Kubernetes platform on EKS.
        \item Decreased deployment times by an order of magnitude.
        \item Building a Change Data Capture (CDC) framework with live updates from PostgreSQL RDS instances via Debezium and Flink to
        Iceberg tables queried via AWS Athena.
        \item Implemented storing infrastructure state (Terraform and Pulumi) as readable files in git.
        \item Migrated all source code repositories from Bitbucket to GitHub, maintaining them with Pulumi.
      \end{itemize}
    }

    \cventry{2019--2020}{DevOps Engineer}{\href{https://www.fexco.com/}{Fexco}}{Killorglin, Ireland (remotely)}{}{
      Member of the Hospitality solution DevOps team \newline{}
      \textbf{Responsibilities}:
      \begin{itemize}
        \item Development and maintenance of the
        \href{http://web.archive.org/web/20200423100452/https://fexco.com/openconnect/hospitality/}{Hospitality solution}
        infrastructure running on GCP (Google Cloud Platform).
    ...
    \cventry{2014--2019}{Site Reliability Engineer}{\href{https://www.google.com/}{Google}}{Dublin}{}{
      ...
      \begin{itemize}
        ...
        Google (oncall, onduty, releases, deployments) on
        \href{https://kubernetes.io/blog/2015/04/borg-predecessor-to-kubernetes/}{borg}.
        \begin{itemize}
          \item root@Google - services that we ran could impersonate
          any Googler / role account.
          \item Critical - if our services broke, no work could be done in the company.
        \end{itemize}
        \item
        ...
        using \href{https://en.wikipedia.org/wiki/Prometheus_(software)\#History}{borgmon}
        and \href{https://research.google/pubs/monarch-googles-planet-scale-in-memory-time-series-database/}{Monarch},
      ...
      \begin{itemize}
        \item BeyondCorp troubleshooting portal 
          ...
          \item Over 30k lines of Golang code maintained in
          \href{https://en.wikipedia.org/wiki/Piper_(source_control_system)}{Piper}.
        ...
        \item SRE onboarded two services:
          ...
          \item
          the Google
          \href{https://www.usenix.org/system/files/login/articles/login_spring16_06_osborn.pdf}{device inventory}
          using Bigtable,
        ...
        \href{https://www.usenix.org/system/files/login/articles/login_winter16_05_cittadini.pdf}{SSH gateways}
  ...
  \section{Education}
    ...
    \cventry{2003--2007}{Master's degree in Computer Science}{University of Łódź}{City}{ISCED 5A}{
      \textbf{Achievements}:
      \begin{itemize}
        \item
  ...
  \section{Languages}
    ...
    I have been working for companies based in the USA and Ireland for the last 13 years.}
